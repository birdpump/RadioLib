...
// === Removed tone-related variables and functions ===
...
//        stdio_init_all(); //this breaks everything if called twice
    ...
    void delay(unsigned long ms) override {
        vTaskDelay(pdMS_TO_TICKS(ms)); // Use FreeRTOS delay function
    }
    ...
    // Removed tone and noTone functions
    ...
    void yield() override {
        taskYIELD(); // Use FreeRTOS yield function
    }
